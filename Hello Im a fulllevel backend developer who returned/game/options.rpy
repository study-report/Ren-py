...
define config.name = _("안녕하세요. 회귀한 만렙 백엔드 개발자입니다.")
...
define build.name = "full_level_backend"
...
define config.save_directory = "HelloImafulllevelbackenddeveloperwhoreturned-1679015517"
